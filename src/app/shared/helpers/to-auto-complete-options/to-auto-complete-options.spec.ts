...
describe(toAutoCompleteOptions.name, () => {
	describe('Default behavior with "id" and "name" properties', () => {
		it('should map an array of objects to AutocompleteOption[] using default id and name properties', () => {
	...
	describe('Custom property names', () => {
		it('should map an array of objects to AutocompleteOption[] using custom properties', () => {
			const source$ = of<Generic[]>([
	...
	describe('Edge cases', () => {
		...
		it('should handle objects missing the specified properties', () => {
			const source$ = of<Generic[]>([
